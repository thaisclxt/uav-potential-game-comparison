...
def extract_num_uavs(file_path: str | Path) -> int:
    """
    Extract the number of UAVs from a filename using a regular expression.

    Example:
        UAVs10_GRID13_waypoints.xlsx -> 10
    """
...
def extract_grid_size(file_path: str | Path) -> int:
    """
    Extract the grid size from the filename using a regular expression.

    Example:
            UAVs10_GRID13_waypoints.xlsx -> 13
    """
